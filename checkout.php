        ...
        <div class="display-order">
            ...
            <div class="checkout-order-display">
                ...
                <div class="checkout-order-display-details">
                    <p><i class="fa-solid fa-product" style="margin-right:10px; color:var(--color-secondary);"></i><?php echo $fetch_cart['title']; ?> <span> - <?php echo '$' . $fetch_cart['price'].' ('.$fetch_cart['quantity']; ?>Qty)</span></p>
                </div>
            </div>
